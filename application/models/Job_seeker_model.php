...
class Job_seeker_model extends MY_Model
{
    ...
    public function sendEmail($to_email,$full_name)
    {
        ...
        $message = '<div style="max-width:600px!important;padding:4px"><table style="padding:0 45px;width:100%!important;padding-top:45px;border:1px solid #f0f0f0;background-color:#ffffff" align="center" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td align="center"></td></tr></tbody></table>
...
<br><br>Hi'.$full_name.',<br><br>Please verify your e-mail to activate your TheOcean Account.<br><br>Once verified, you can browse TheOcean !<br><br>You can confirm your e-mail by clicking the button below <br><br><a style="border-radius:4px;font-size:15px;color:white;text-decoration:none;padding:14px 7px 14px 7px;width:210px;max-width:210px;font-family:&quot;Open Sans&quot;,&quot;Helvetica Neue&quot;,Arial;margin:0;display:block;background-color:#6caa4d;text-align:center" href="' . base_url() . 'register/verify/' . md5($to_email) . '">Activate Account</a><br><br>Alternately, copy paste and open the link in your browser.<br><br>' . base_url() . 'register/verify/' . md5($to_email) . '<br><br>Thanks,<br><br>Team TheOcean<br><br>Copyright © 2020 TheOcean, All rights reserved.</td></tr><tr><td height="40"></td></tr></tbody></table>';
