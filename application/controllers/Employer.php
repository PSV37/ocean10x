                ...
                if ($exists == true) {
                    if (isset($id) && !empty($id)) {
                        ...
                        if (empty($job_apply_data)) {
                            ...
                            $frwd = $this->Master_model->master_insert($frwd_array, 'forwarded_jobs_cv');
                            $external_array = array('cv_id' => $cv_id, 'company_id' => $employer_id, 'job_post_id' => $job_post_id, 'apply_id' => $apply, 'status' => 1, 'company_id' => $company_id, 'name' => $this->input->post('
                                        candidate_name'), 'email' => $this->input->post('candidate_email'), 'mobile' => $this->input->post('candidate_phone'), 'created_on' => date('Y-m-d H:i:s', strtotime('+5 hours +30 minutes')),);
                            $frwd = $this->Master_model->master_insert($external_array, 'external_tracker');
                        }
                        if ($apply) {
...
Team ConsultnHire!<br>Thank You for choosing us!<br>Goa a Question? Check out how works and our support team are ready to help.<br><br>© 2017 ConsultnHire All Rights Reserved.<br><br>You have received this mail because your e-mail ID is registered with Consultnhire.com. This is a system-generated e-mail regarding your Consultnhire account preferences, please do not reply to this message. The jobs sent in this mail have been posted by the clients of Consultnhire.com. And we have enabled auto-login for your convenience, you are strongly advised not to forward this email to protect your account from unauthorized access. IEIL has taken all reasonable steps to ensure that the information in this mailer is authentic. Users are advised to research bonafides of advertisers independently. Please do not pay any money to anyone who promises to find you a job. IEIL shall not have any responsibility in this regard. We recommend that you visit our Terms & Conditions and the Security Advice for more comprehensive information.</td></tr><tr><td height="40"></td></tr></tbody></table></td></tr></tbody></table></div>';
    ...
    public function insert_test_data() {
        if (!empty($_POST)) {
            ...
            foreach ($questions as $row) {
                ...
                $exam_array = array('test_id' => $test_id, 'employee_id' => $employer_id, 'question_id' => $row, 'marks' => $mark, 'correct_status' => $status, 'date_time' => $cenvertedTime);
    ...
    function get_shared_list()
    {
        ...
        $array = implode("','",$array);
           ...
           $result = '<li class="deprecated-mdc-list-item boqDrivesharedialogPermissionslistPermissionrowListItem boqDrivesharedialogCommonListOverrideMdcListItemOverflow" jsname="CmABtb" role="menuitem" tabindex="-1" aria-selected="false"><div jscontroller="pSAyzd" jsaction="hG89Hb:jIgFsc;Vi1A2:GC7Jyc;Rl51If:b75uZ;W3r7Kc:CDaJoe;kky1rc:dXOPge;U5hm6d:YWywm;pR5nId:E0TiDb;JIbuQc:dXOPge(rC8m8e),YWywm(TvD9Pc),nEqQyd(vkvpsc),vImX0b(cTSltc); click:AJI9fd" class="boqDrivesharedialogPermissionslistPermissionrowPermissionRowContainer"><div jsname="GwKe0b" class="boqDrivesharedialogPermissionslistPermissionrowPermissionRow"><div class="boqDrivesharedialogPermissionslistPermissionrowSummary" jsname="HSrbLb"><div class="boqDrivesharedialogPermissionslistPermissionrowIconContainer" data-hovercard-id="amishra@tele-kinetics.com"><div role="img" class="boqDrivesharedialogPermissionslistPermissionrowNoImage ">A</div></div><div class="boqDrivesharedialogPermissionslistPermissionrowMain" data-hovercard-id="amishra@tele-kinetics.com" data-hovercard-owner-id="130"><div class="boqDrivesharedialogPermissionslistPermissionrowPrimary" aria-label="Awaneesh Mishra.">Awaneesh Mishra</div><div class="boqDrivesharedialogPermissionslistPermissionrowSecondary" aria-label="amishra@tele-kinetics.com.">amishra@tele-kinetics.com</div></div><div class="boqDrivesharedialogPermissionslistPermissionrowRole"><div class="boqDrivesharedialogPermissionslistPermissionrowError" jsname="u0pjoe"></div><div jscontroller="UcGDRd" class="boqDrivesharedialogCommonRoleselectorRoleSelector" jsaction="iFFCZc:oNPcuf;Rld2oe:li9Srb;FzgWvd:uXu05d;bhAMEd:F6RGl;Jm1MTc:a1dNLd; focusin:h06R8" jsname="JR0ttb"><div jscontroller="wg1P6b" jsaction="JIbuQc:JIbuQc(WjL7X); keydown:I481le(WjL7X);iFFCZc:Y0y4c;Rld2oe:gDkf4c" class="mdc-menu-surface--anchor" jsname="pzCKEc"><div jsname="WjL7X"><button class="mdc-button GmButtonGreyInkText GmButtonGreyInkTextDarkTheme boqDrivesharedialogCommonRoleselectorMenuTextButton boqDrivesharedialogCommonRoleselectorOwnerText" jscontroller="soHxf" jsaction="click:cOuCgd; mousedown:UX7yZ; mouseup:lbsD7e; mouseenter:tfO1Yc; mouseleave:JywGue; touchstart:p6p2H; touchmove:FwuNnf; touchend:yfqBxc; touchcancel:JMtRjd; focus:AHmuwe; blur:O22p3e; contextmenu:mg9Pef" jsname="dLruDf" disabled="" aria-label="Owner." aria-expanded="false" aria-haspopup="menu" tabindex="0"><div class="mdc-button__ripple"></div><span jsname="V67aGc" class="mdc-button__label">Owner</span></button></div><div jsname="U0exHf"> <div class="mdc-menu-surface mdc-menu-surface--fixed mdc-menu GmMenu GmMenuDarkTheme boqDrivesharedialogCommonMenuMenu" jsname="va9jKc" jscontroller="ywOR5c" jsaction="keydown:I481le;xDliB:llTnze;SM8mFd:xTMeO;JIbuQc:RFVo1b(rymPhb)" data-is-hoisted="false"><ul jscontroller="PHUIyb" class="mdc-list mdc-list--textual-list GmList" jsname="rymPhb" jsaction="mouseleave:JywGue; touchcancel:JMtRjd; focus:AHmuwe; blur:O22p3e; keydown:I481le" role="menu" tabindex="-1" aria-label="Menu for selecting permission roles" id="c595" aria-hidden="true"><span aria-hidden="true" class="mdc-elevation-overlay GmElevationOverlay"></span></ul></div></div></div></div></div></div></div></div></li>';
