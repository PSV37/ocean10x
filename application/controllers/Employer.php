...
';
    ...
    public function all_questions() {
        ...
        $select_appeared_questions = "oceanchamp_tests.total_questions";
        $data['Appeared_in_test_papers'] = $this->Master_model->master_get_num_rows('oceanchamp_tests', $where = FALSE, $like = false, $join=false, $select_appeared_questions);
