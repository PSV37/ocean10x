...
//$days_count=30*stability;
        ...
        $join_cond = array('cv_folder_relation' => 'cv_folder_relation.cv_id = cv_folder.cv_id|left', 'corporate_cv_bank' => 'corporate_cv_bank.cv_id = cv_folder_relation.cv_id|left');
