        ...
        if (!empty($test_id)) {
           ...
           // foreach ($oceanchamp_tests as $question) {
             ...
             //     
                  ...
                  $question_data  = $this->Master_model->get_master_row('questionbank', $select = 'questionbank.question,JSON_UNQUOTE(JSON_OBJECT("a",questionbank.option1,"b",questionbank.option2,"c",questionbank.option3,"d",questionbank.option4 )) as answers', $where, $join = false);
