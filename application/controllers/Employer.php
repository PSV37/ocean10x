...
//$days_count=30*stability;
        ...
        $join_cond = array('cv_folder_relation' => 'cv_folder_relation.cv_id = corporate_cv_bank.cv_id | left', 'corporate_cv_bank' => 'corporate_cv_bank.cv_id = cv_folder_relation.cv_id | left', 'js_info' => 'js_info.email = corporate_cv_bank.js_email|Left', 'js_login_logs' => 'js_info.job_seeker_id = js_login_logs.job_seeker_id|Left');
