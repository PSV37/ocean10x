    ...
    {   
        ...
        if (!empty($job_id)) {
           ...
           foreach($job_test_topics as $topic_row)
           {
            ...
            $topics_ques = $this->Master_model->getMaster('questionbank',$where_topic,$join = FALSE, $order = false, $field = false, $select = false,$limit='$no_ques',$start=false, $search=false);
