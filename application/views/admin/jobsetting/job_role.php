    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/job_role/save_role/<?php  if (!empty($edit_skill_info)) { foreach($edit_skill_info as $row)
                        echo $row['id'];
                      }
                     ?>" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="job_role_title" class="form-control" value="<?php if (!empty($edit_skill_info)) echo $row['job_role_title'];?>" placeholder='Role Title' required>
                                    </div>
                                </div>
                                <div class="panel-body"></div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Skill Set <span class="required">*</span></label> <br><br>
