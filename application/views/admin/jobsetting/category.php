        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form role="form" enctype="multipart/form-data"
                      ...
                      action="<?php echo base_url(); ?>admin/job_category/save_category/<?php
                ...
                <table class="table table-bordered table-striped" id="dataTables-example">
                    ...
                    <?php if (!empty($all_category)): foreach ($all_category as $v_category) : ?><!--get all category if not this empty-->
                        <tr>
                            <td><?php echo $key ?></td>
                            <!--Serial No> -->
                            <td><?php echo $v_category->job_category_name ?></td>
                            <td>
                                <?php echo btn_edit('admin/job_category/edit_category/' . $v_category->job_category_id); ?>
                                <?php echo btn_delete('admin/job_category/delete_category/' . $v_category->job_category_id); ?>
                            </td>
