    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/topic_master/save_topic/<?php  if (!empty($edit_special_info)) { foreach($edit_special_info as $row)
                        echo $row['topi		c_id'];
                      }
                     ?>" method="post">
