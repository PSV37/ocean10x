                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                     ...
                                     <input type="text" name="topic_name" class="form-control" value="<?php if (!empty($edit_spectial_info)) echo $row['topic_name'];?><?php echo set_value('topic_name'); ?>" placeholder='Topic Name'>
