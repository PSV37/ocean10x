    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/topic/save_topic/index<?php  if (!empty($edit_topic_info)) { foreach($edit_topic_info as $row)
                        echo $row['id'];
                      }
                     ?>" method="post">
