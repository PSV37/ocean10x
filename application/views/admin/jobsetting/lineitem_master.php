                ...
                <form role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/lineitem/save_lineitem/<?php  if (!empty($subtopic)) { foreach($subtopic as $row)
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" name="topic_id" id="topic_id"  class="form-control" value="<?php if (!empty($edit_subtopic_info)) echo $row['topic_id'];?>" required/>
                                    <input type="text" name="subtopic_name" id="subtopic_name"  class="form-control" value="<?php if (!empty($subtopic)) echo $row['subtopic_id'];?>" required/>
