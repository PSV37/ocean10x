        ...
        <input type="checkbox" id="three" name="correct_answer[]" value="5" <?php if (!empty($edit_questionbank_info)) if($row['correct_answer']=='5')echo "checked";?>/>&nbsp;Option5</label>-->
			...
			<?php 
				  if(!empty($options))
					...
					?>
                    <br/><input type="checkbox" <?php echo $checked; ?> name="correct_answer[]" id="correct_answer[]" value="<?php echo $key['options_id'];?>">&nbsp;&nbsp;<span style="margin-top:-5px;"><?php echo $key['options_type']; ?></span>&nbsp;
				<?php
					}
				?>
