        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header box-header-background with-border">
                        ...
                        <h3 class="box-title ">Deactive Company List</h3>
                ...
                <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="dataTables-example">
                            ...
                            <?php if (!empty($deactive_companys)): foreach ($deactive_companys as $v_company) : ?>
                                <tr class="custom-tr">
                                    ...
                                    <td class="vertical-td highlight">
                                        <a href="<?php echo base_url(); ?>admin/<?php echo $v_company->company_profile_id; ?>">
