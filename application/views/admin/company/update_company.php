                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                         <div class="form-group">
                                           <label class="control-label">Head Office: <span class="required">*</span></label>
                                            <textarea  name="company_address"  id="company_address" class="form-control" rows="8" id="comment"><?php if(!empty($company_profile->company_address)){
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                         ...
                                         <textarea  name="company_service" id="company_service" class="form-control" rows="8" id="comment"><?php if(!empty($company_profile->company_service)){
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                         <div class="form-group">
                                           <label class="control-label">Special Features: <span class="required">*</span></label>
                                            <textarea  name="company_aboutus"  id="company_aboutus" class="form-control" rows="8"><?php  if(!empty($company_profile->company_aboutus)){
  ...
  <option value="1" <?php echo $company_profile->hot_jobs=='1' ? 'selected="selected"' : ''; ?> >Selected Resume</option>
    <option value="2" <?php echo $company_profile->hot_jobs=='2' ? 'selected="selected"' : ''; ?> >University</option>
        <option value="3" <?php echo $company_profile->hot_jobs=='3' ? 'selected="selected"' : ''; ?> >Bank Books</option>
                     ...
                     <button type="submit" class="btn bg-navy" type="submit">Save Company
                                </button>
                </form>
