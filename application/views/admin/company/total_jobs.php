                ...
                <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="dataTables-example">
                            ...
                            <tr>
                                ...
                                <th class="active">CVs viewed  </th>
                                <th class="active">Pending CVs </th>
                            ...
                            <?php $i=1; if (!empty($company_all_jobs)): foreach ($company_all_jobs as $v_companyjobs) : ?>
                                <tr class="custom-tr">
                                 <td class="vertical-td"><?php echo $i++; ?> </td>
                                    <td class="vertical-td highlight">
                                        <a href="<?php echo base_url(); ?>admin/company_profile/view_company/<?php echo $v_companyjobs->company_profile_id; ?>" data-toggle="modal" data-target="#myModal-<?php echo $v_companyjobs->company_profile_id; ?>">
                                            <?php echo $v_companyjobs->job_title; ?></a>
                                    </td>
                                    <td class="vertical-td">10 </td>
                                    <td class="vertical-td">10 </td>
                                    <td class="vertical-td">10 </td>
                                    <td class="vertical-td">10 </td>
                                    <td class="vertical-td">20/10/2016</td>
                                    <td class="vertical-td">20/10/2016</td>
