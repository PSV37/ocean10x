        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header box-header-background with-border">
                        ...
                        <h3 class="box-title ">All Company List</h3>
                ...
                <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="dataTables-example">
                            ...
                            <?php if (!empty($all_company)): foreach ($all_company as $v_company) : ?>
                                <tr class="custom-tr">
                                    ...
                                    <td class="vertical-td">
                                        ...
                                        <?php echo btn_edit('admin/company/edit_company/' . $v_company->company_profile_id); ?>
