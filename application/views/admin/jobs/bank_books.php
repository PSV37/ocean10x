    ...
    <div class="row">
      ...
      <div class="box box-primary">
                <div class="box-header box-header-background with-border">
                        ...
                        <h3 class="box-title ">Total Bank Books</h3>
                ...
                <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped" id="dataTables-example">
                            ...
                            <?php $i=1; if (!empty($all_bank_books)): foreach ($all_bank_books as $v_companyjobs) : ?>
                                <tr class="custom-tr">
                                 <td class="vertical-td"><?php echo $i++; ?> </td>
                                   ...
                                   <a href="<?php echo base_url(); ?>job/show/<?php echo $v_companyjobs->job_slugs; ?>">
                                    ...
                                    <td class="vertical-td">
                                            ...
                                            <span class="label label-primary">Bank Books</span>
