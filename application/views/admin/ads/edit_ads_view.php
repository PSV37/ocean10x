    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/ads/update_ads/<?php
                      if (!empty($ads_row->ID)) {
                          echo $ads_row->ID;
                      }
                      ?>" method="post">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="ad_image" placeholder="Ad Image" value="" class="form-control">
                                    <label for="exampleInputEmail1">Ads Link <span class="required">*</span></label>
                                    <input type="text" required name="ad_link" placeholder="Ad Link" value="<?php echo $row->ad_link;?>" class="form-control">
                                    <label for="exampleInputEmail1">Ads Position <span class="required">*</span></label>
                                   
                                   <?php if($row->ID>8):?>
                                   <select name="position" class="form-control">
                                   <option value="leftside" <?php echo ($row->position=='leftside')?'selected':'';?>>Left Side</option>
                                   <option value="rightside" <?php echo ($row->position=='rightside')?'selected':'';?>>Right Side</option>
                                   </select>
                                   <?php else:?>
                                   	<input type="text" name="position" value="home" readonly />
                                   <?php endif;?>
                                   <input type="hidden" name="aid" id="aid" value="<?php echo $row->ID;?>" />
                                </div>

                                <button type="submit" class="btn bg-navy" type="submit">Update Ad</button><br/><br/>
                            </div>
                            <!-- /.box-body -->
