  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <h1 class="page-heading">Import Question Bank</h1>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="breadCrumb"><a href="#.">Home</a> / <span>Import Questions</span></div>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="content col-md-9">
        <div class="userccount empdash">
          <div class="formpanel"> <?php echo $this->session->flashdata('success'); ?>
      		  ...
      		  <form method='post' action="<?php echo base_url();?>question-bank" enctype="multipart/form-data">
