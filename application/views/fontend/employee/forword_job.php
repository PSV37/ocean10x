...
<div class="pageTitle">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6">
        <div class="breadCrumb"><a href="#.">Home</a> / <span>Forward Job</span></div>
      </div>
    </div>
  </div>
</div>
      ...
      <div class="content col-md-9">
        <div class="userccount empdash">
          <div class="formpanel"> <?php echo $this->session->flashdata('success'); ?>
            <form id="submit" action="<?php echo base_url() ?>employee/forword_job_post" method="post" class="submit-form">
