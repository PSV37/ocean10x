...
<div class="section lb">
          ...
          <div class="postviewbox">
            ...
            <ul class="countlist row">
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>all-applicants/<?php echo $job_id;?>"> <?php echo $this->job_apply_model->count_job_apply($job_id,$company_id);?> </a> </div>
                <h6>All list</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>employee/view_resumelist/<?php echo $job_id; ?>"> <?php echo $this->job_apply_model->count_resume_view($job_id,$company_id);?> </a></div>
                <h6>View</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>employee/not_view_resumelist/<?php echo $job_id; ?>"> <?php echo $this->job_apply_model->count_resume_not_view($job_id,$company_id);?> </a> </div>
                <h6>Not View</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>sortlist-cv/<?php echo $job_id; ?>"> <?php echo $this->job_apply_model->count_job_apply_sortedlist($job_id,$company_id);?> </a> </div>
                <h6>Sort List</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>interview-cv/<?php echo $job_id; ?>" class="active"> <?php echo $this->job_apply_model->count_job_apply_inteviewlist($job_id,$company_id);?> </a></div>
                <h6>Interview</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>final-cv/<?php echo $job_id; ?>"> <?php echo $this->job_apply_model->count_job_apply_finallist($job_id,$company_id);?> </a></div>
                <h6>Final list</h6>
              </li>
            </ul>
          </div>
          <hr>
          <div class="totalcandi">Total Interviews <span> <?php echo $this->job_apply_model->count_job_apply_inteviewlist($job_id,$company_id);?></span></div>
          <div class="sortbycad">
            <div class="row">
              <div class="col-md-4"><strong>Download this List: <a href="#."><i class="fa fa-file-word-o" aria-hidden="true"></i></a></strong></div>
            
            </div>
          </div>
          <ul class="viewseekers">
            <?php $i=1; if (!empty($interview_cvs)): foreach ($interview_cvs as $v_applicant) : $seeker_info=$this->job_seeker_model->applicant_job_seeker($v_applicant->job_seeker_id);?>
            <li>
              <div class="row">
                <div class="col-md-2">
 ...
 <?php echo $this->job_apply_model->expedited_salary($v_applicant->job_seeker_id,$job_id)[0]->expected_salary; ?> 
                  ...
                  <div class="sorted">
                    ...
                    <span class="label label-success"> <i class="fa fa-check" aria-hidden="true"></i> <?php echo 'Final' ?> </span>
                    <?php } ?>
                  </div>
                  <a href="<?php echo base_url() ?>employee/downloadcv/<?php echo $v_applicant->job_seeker_id; ?>" class="downcv" title="Download CV"> <i class="fa fa-download" aria-hidden="true"></i> Download </a> </div>
                <div class="col-md-2">
                  <div class="action">
                    <?php 
							if($v_applicant->apply_status==0){
							echo btn_sorted('employee/update_sortlist/' . $v_applicant->job_apply_id.'/'. base64_encode($seeker_info->email)).'<br> shorted list'; }
                  ...
                  <a href="<?php echo base_url() ?ereject-resume/<?php echo $v_applicant->job_seeker_id; ?>" class="reject"> <i class="fa fa-times" aria-hidden="true"></i> <strong>Reject</strong> </a> </div>
                  <div class="col-md-12">
