...
<div class="section lb">
 ...
 <?php if($job_details->job_status=="1"){
          ...
          <div class="postviewbox">
            ...
            <ul class="countlist row">
              ...
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>interview-cv/<?php echo $job_id; ?>"> <?php echo $this->job_apply_model->count_job_apply_inteviewlist($job_id,$company_id);?> </a></div>
                <h6>Interview</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>final-cv/<?php echo $job_id; ?>" class="active"> <?php echo $this->job_apply_model->count_job_apply_finallist($job_id,$company_id);?> </a></div>
                <h6>Final list</h6>
              </li>
            </ul>
          </div>
          <hr>
          <div class="totalcandi">Total Final Candidates <span> <?php echo $this->job_apply_model->count_job_apply_finallist($job_id,$company_id);?></span></div>
          <div class="sortbycad">
            <div class="row">
 ...
 <?php echo $this->job_apply_model->expedited_salary($v_applicant->job_seeker_id,$job_id)[0]->expected_salary; ?> 
                ...
                <div class="col-md-2">
                  ...
                  <a href="<?php echo base_url() ?>reject-resume/<?php echo $v_applicant->job_seeker_id; ?>" class="reject"> <i class="fa fa-times" aria-hidden="true"></i> <strong>Reject</strong> </a> </div>
                  <div class="col-md-12">
