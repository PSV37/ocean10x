        ...
        <form method="post" action="<?php echo base_url();?>employee/addconsultant" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">   
                                           <div class="formrow">
                                            ...
                                            ?>" class="form-control" placeholder="Consultancy Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                          <div class="formrow">
                                            ...
                                            ?>" class="form-control" placeholder="Consultancy Email">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                          ...
                                          <label class="control-label">Consultancy URL:</label>
                                            ...
                                            ?>" class="form-control" placeholder="Consultancy Website">
                                            </div>
                                        </div>
                   ...
                   <div class="row">
                            ...
                            <div class="formrow">
                              ...
                              ?>" placeholder="Consultancy Career Link">
                            </div>
                          </div>
