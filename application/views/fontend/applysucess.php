        ...
        <div class="userccount">
            ...
            <p>Sucessfully apply this job . <br>
              <?php if(!empty($job_test))
                ...
                {
              ?>
                <br>If you want's to increase your chance for this job please go through online test. <br><a href="<?php echo base_url(); ?>/exam/index/<?php echo base64_encode($job_id); ?>" class="btn btn-primary">Go Now </a>&nbsp;&nbsp; <a href="<?php echo base_url(); ?>" class="btn btn-info">Go Later </a>.</p>
