      ...
      <div class="col-sm-9 col-md-9 col-lg-9 jobsectionsbottom">
        <ul class="searchList">
          ...
          <li class="trainingbox">
            <div class="row">
              <div class="col-md-2 col-sm-3"> <img src="<?php echo base_url(); ?>upload/training/<?php echo $v_training->training_logo; ?>"> </div>
              <div class="col-md-10 col-sm-9">
                <div class="jobinfo">
                  ...
                  <div class="inftxt"><strong>Training Type :</strong>
                    <?php if($v_training->training_type=='1')
                                    { echo "Workshop";}
        ...
        <nav aria-label="Page navigation">
          <ul class="pagination">
            <?php    if($offset>0): ?>
            <li> <a href="<?php echo base_url('training/page/'.($offset-1)); ?>" aria-label="Previous"> <span aria-hidden="true">«</span> </a> </li>
            <?php endif; ?>
            <?php 
                        $maxpage=ceil($totalrow/$limit); 
                        for($i=0; $i<$maxpage; $i++): ?>
            <li><a class="<?php echo $offset==$i?'active':''; ?>" href="<?php echo base_url('training/page/'.$i); ?>"><?php echo $i+1; ?></a></li>
            <?php endfor; ?>
            <?php if($offset<$maxpage-1): ?>
            <li> <a href="<?php echo base_url('training/page/'.($offset+1)); ?>" aria-label="Next"> <span aria-hidden="true">»</span> </a> </li>
            <?php endif; ?>
            <?php ?>
          </ul>
        </nav>
