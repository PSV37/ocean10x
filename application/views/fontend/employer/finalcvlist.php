 ...
 <?php if($job_details->job_status=="1"){
          ...
          <div class="postviewbox">
            ...
            <ul class="countlist row">
              ...
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>employer/interview-cv/<?php echo $job_id; ?>"> <?php echo $this->job_apply_model->count_job_apply_inteviewlist($job_id,$company_id);?> </a></div>
                <h6>Interview</h6>
              </li>
              <li class="col-md-2 col-sm-4 col-xs-6">
                <div class="countcirc"><a href="<?php echo base_url() ?>employer/final-cv/<?php echo $job_id; ?>" class="active"> <?php echo $this->job_apply_model->count_job_apply_finallist($job_id,$company_id);?> </a></div>
                <h6>Final list</h6>
              </li>
            </ul>
          </div>
            ...
            <li>
              <div class="row">
        		...
        		<?php $exp=($this->Job_seeker_experience_model->experience_list_by_id($v_applicant->job_seeker_id)); ?>
						<div class="uniname"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $seeker_info->company_name; ?></div>
                    	<!--<div class="exp">
