                                        ...
                                        <div class="row">
										   ...
										   <div class="col-md-6 col-sm-12">
                                              <select  name="company_category" id="company_category" class="form-control services">
                                                ...
                                                <option value="<?php echo $dept['job_category_id']; ?>"<?php echo set_select('company_category', $dept['id'], TRUE);?>><?php echo $dept['job_category_name']; ?></option>
                                                <?php } ?>
                                              </select> </div>
                                          </div><!-- end row -->
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12">
                                              <select  name="country_id" id="country_id" class="form-control country" onchange="getStates(this.value)">
                                                ...
                                                <option value="<?php echo $key['country_id']; ?>"<?php echo set_select('country_id', $dept['id'], TRUE);?>><?php echo $key['country_name']; ?></option>
                                                <?php } ?>
                                              </select>
                                            </div>
