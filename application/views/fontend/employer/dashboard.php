		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('#addMoreBranches').click(function(){ 
				 $('#BranchTable tbody').append("<tr id='Branchtr"+j+"'><td class='hidden'>"+j+"</td><td><input type='text' class='form-control' name='BranchName"+j+"' id='BranchName"+j+"' required></td><td><select name='BranchCountry"+j+"' id='BranchCountry"+j+"' onchange='getState("+j+"); class='form-control' required><?php foreach($country as $key){?>
											<option value="<?php echo $key['country_id']; ?>"<?php if($company_info->country_id==$key['country_id']){ echo "selected"; }?>><?php echo $key['country_name']; ?></option><?php } ?></select></td><td ><input type='text' class='form-control'  name='BranchState"+j+"' id='BranchState"+j+"' required ></td><td><input type='text' class='form-control' name='BranchCity"+j+"' id='BranchCity"+j+"' readonly></td><td><input type='text' class='form-control' name='BranchPincode"+j+"' id='BranchPincode"+j+"' readonly></td><td><a href='#' class='removebtn' id='"+j+"' onclick='removePathologyTr(this);'>X</a></td></tr></div></div>"); 
			})
			});
		</script>
