          ...
          <div class="formpanel"> <?php echo $this->session->flashdata('success'); ?>
            <form id="submit" action="<?php echo base_url() ?>employer/job_post" method="post" class="submit-form">
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="formrow">
                    <label>Working Hours<span class="required">*</span></label>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-12">
                  <div class="formrow">
                    <label>Job Deadline<span class="required">*</span></label>
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                  <div class="formrow">
                    <label>Required Education<span class="required">*</span> </label>
