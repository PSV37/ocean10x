      ...
      <div class="col-md-12">
         ...
         <div class="col-md-6 question-bank">
            ...
            <ul id="myTabs" class="" role="tablist" data-tabs="tabs">
               <li class="btn btn-secondary <?php $submenu=$this->session->userdata('submenu'); $activemenu=$this->session->userdata('activemenu'); if(isset($submenu) && !empty($submenu)){
                if($submenu == 'qbank' ) { echo 'active'; } }else{  echo 'active'; } ?> "><a href="#qbank" data-toggle="tab">Question Bank</a></li>
