              ...
              <!-- <div class="btn-group-toggle" data-toggle="buttons" >
                ...
                <div class="row">
                  <div class="box" >
                    ...
                    $jobs_data = $this->Master_model->getMaster('oceanchamp_tests', $where , $join, $order = 'desc', $field = 'date', $select = '*,IFNULL(forwarded_tests.updated_on, job_posting.update_at,oceanchamp_tests.updated_on) AS date',$limit=false,$start=false, $search=false); 
