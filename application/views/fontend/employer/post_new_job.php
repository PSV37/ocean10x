               ...
               <!-- <section> -->
                  <div class="col-md-3 col-sm-4" tabindex="0">
                     <div class="formrow">
                        ...
                        <input class="form-control allowalphanumeric" type="text"  name="job_title"  id="job_title" value="<?php if(!empty($this->session->userdata('title')) ){echo $this->session->userdata('title'); } elseif(!empty($job_info->job_title)){
