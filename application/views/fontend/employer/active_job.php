                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <span data-placement="top" data-toggle="tooltip" title="Forword Job"><a href="<?php echo base_url() ?>employer/forword_job/<?php echo $v_companyjobs->job_post_id ?>" class="btn btn-primary btn-xs"><i class="fa fa-paper-plane"></i> Forword</a></span>
                                    </div>
                                </div>
                            </div>
                        </li>
