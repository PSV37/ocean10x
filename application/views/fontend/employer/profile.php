          ...
          <div class="row f-1">
            <div class="col-md-6 col-sm-12">   
              <div class="formrow">
                ...
                <input type="text" required="" name="company_name" class="form-control" placeholder="Company Name" value="<?php if(!empty($company_info->company_name)){ echo $company_info->company_name; } ?>" class="form-control" placeholder="Company Name" required  id="reg_user" min="1" maxlength="2" >
              </div>
            </div>
