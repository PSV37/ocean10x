              ...
              <tbody>
                ...
                <tr <?php if($key['emp_status']=='0' || $key['emp_status']=='3' ){?> style="background: #CCC;" <?php } ?>>
                 ...
                 elseif($key['emp_status']=='2')
                  ...
                  <td style=""><button class="btn btn-primary" title='Activate' data-toggle="modal"  name="status" id="status" onclick="Activate_user(this.value);" value="<?php echo $key['emp_id'];?>" >Activate</button></td>
