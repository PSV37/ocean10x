      ...
      <div class="content col-md-9">
        <div class="userccount empdash">
          <div class="formpanel"> <?php echo $this->session->flashdata('msg'); ?>
            ...
            <form role="form" id="test_topicfrm"  enctype="multipart/form-data" action="<?php echo base_url(); ?>employer/topics_for_test/<?php if (!empty($test_job_id)) { echo $test_job_id;} ?>" method="post" onsubmit="return validate_val();">
