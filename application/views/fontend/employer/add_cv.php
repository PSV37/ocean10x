                ...
                <div class="col-md-12">
	                ...
	                <div class="col-md-4">
					  	<div class="form-group">
		                    ...
		                    </select>  <?php echo form_error('job_type'); ?>  
						</div>
					</div>
                </div>
                ...
                <div class="col-md-4">
				  	<div class="form-group">
	                    <label for="exampleInputEmail1">Working at Current Job Since</label>
	                 	<input type="text" name="working_current_since" id="working_current_since" class="form-control datepicker hasDatepicker">  <?php echo form_error('current_work_location'); ?>   
					</div>
				</div>
                <div class="col-md-4">
				  	<div class="form-group">
                ...
                <div class="col-md-4">
				  	<div class="form-group">
	                    <label for="exampleInputEmail1">Last Salary Hike</label>
	                 	<input type="text" name="last_salary_hike" id="last_salary_hike" class="form-control datepicker hasDatepicker">  <?php echo form_error('last_salary_hike'); ?>     
					</div>
				</div>
                ...
                <div class="col-md-4">
				  	<div class="form-group">
	                    <label for="exampleInputEmail1">Skills</label>
	                 	<div class="tokenfield form-control"><input type="text" name="candidate_skills" id="tokenfield" class="skill form-control" value="" tabindex="-1" style="position: absolute; left: -10000px;"><input type="text" tabindex="-1" style="position: absolute; left: -10000px;"></div>        <?php echo form_error('skills'); ?>   
					</div>
				</div>
					  	...
					  	<div class="form-group">
		                    <label for="exampleInputEmail1">Industry</label>
		                 	<select id="candidate_industry" name="candidate_industry" class="form-control">
	                      	...
	                      	</select>   <?php echo form_error('candidate_industry'); ?>
						</div>
					</div>
		                    ...
		                    <label for="exampleInputEmail1">Role</label>
		                 	<select id="candidate_role" name="candidate_role" class="form-control">
		                      ...
		                      <?php if (!empty($job_role)): foreach ($job_role as $role_row) : ?>
	                      	  ...
	                      	  <?php  endforeach; endif; ?>
	                      	</select>   <?php echo form_error('candidate_role'); ?>
						</div>
					</div>
            	</div>
                <div class="col-md-12"> 
