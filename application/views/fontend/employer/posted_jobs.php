                  ...
                  <div class="card">
                    <div class="front">
                      ...
                      <div class="following-info3">
                        ...
                        <li class="left-title">Published on</li><li class="right-title">&nbsp;:<?php if(!is_null($v_companyjobs->created_at)) { echo date('F j Y',strtotime($v_companyjobs->created_at)); } ?></li>
