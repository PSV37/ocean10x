                  ...
                  <div class="dash-box-w">
                     ...
                     <div class="col-md-4 card-lb">
                        <div class="card text-white bg-bluish o-hidden h-100">
                           ...
                           <a class="card-footer text-white clearfix small z-1" href="#">
                           <span class="float-left" style="font-size:22px;"><span><?php echo $open_positions[0]; ?></span>
                           </a>
                        </div>
                     </div>
                     <div class="col-md-4 card-lb">
                        <div class="card text-white bg-link o-hidden h-100">
                           ...
                           <a class="card-footer text-white clearfix small z-1" href="#">
                           <span class="float-left" style="font-size:22px;"><span><?php echo $success_full_hiring; ?></span> 
                           </a>
                        </div>
                     </div>
                     <div class="col-md-4 card-lb">
