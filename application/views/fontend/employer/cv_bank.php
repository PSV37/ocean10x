   ...
   <div class="container">
      <div class="col-md-12">
         ...
         <div id="smsg">
            ...
            <div class="row">
               <div class="col-md-12">
                  <button class="folder_popup" class="btn btn-info btn-lg" data-toggle="modal" data-keyboard="true" data-target="#myModal_add" style="float: right;">Create&emsp;<i class="fas fa-folder-open"></i></button>
               </div>
            </div>
            <div class="row">
               <div class="col-md-6">
                     ...
                     <div class="front">
                        ...
                        <div class="job-info">
                           <div class="a" style="display: inline-flex;">
                              <li class="right-title" style="font-size:19px;margin-top:-4px;"  ><a href="<?php echo base_url(); ?>employer/edit_cv/<?php echo base64_encode($cv_row['cv_id']); ?>" ><?php echo $cv_row['js_name']; ?></a></li>
