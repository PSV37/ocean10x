 ...
 <div id="smsg"><?php echo $this->session->flashdata('success'); ?></div>
         ...
         <div class="col-md-3 right_side">
                           ...
                           <div class="modal-body">
                              ...
                              <div class="col-md-12">
                                 <div class="row">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                      <!--  <input type='file' name='file' required class="form-control" > -->
                                       <input type='file'  required class="form-control" name="pictures[]" id="files" multiple="" directory="" webkitdirectory="" mozdirectory="">
                                    </div>
                                 </div>
                              </div>
            ...
            <div class="filter1">
               ...
               <div class="range-wrap">
                  <input type="range" class="range" id="notice_period_id" onchange="get_data();" min="0" max="90" step="5">
