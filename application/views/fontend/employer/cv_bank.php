         ...
         <div class="col-md-3 right_side">
            ...
            <div class="filter1">
               ...
               <div class="range-wrap">
                  ...
                  <output class="bubble notice_period" id="notice_period_val"></output>
               </div>
            </div>
            <div class="filter1">
...
<script>
   ...
   {
      var value = $('#exp').val();
      var notice_period_value = $('#notice_period_id').text();
      ...
      var stability_value = $('#stability_id').val();
       $.ajax({
               ...
               type: "POST",
               data:{exp:value, notice_period_id:notice_period_value, education_id:education_value, current_ctc_id:current_ctc_value  },
