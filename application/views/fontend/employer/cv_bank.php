              ...
              <div class="front">
                ...
                <?php  
                    ...
                    <?php if ($cv_row['forwarded_cv'] == 1 ) { 
                      ...
                      ?>
                      <span data-toggle="collapse" data-target="#cc<?php echo $cv_row['cv_id']?>" aria-expanded="false" aria-controls="collapseEx"  style="color: red;font-size: 22px;margin-left: 5px;/* margin-top: 55px; */" title="<?php echo $comp_data['company_name']; ?> has Forwarded this CV " class="required"> # </span>
