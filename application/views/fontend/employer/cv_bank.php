          ...
          <div class="col-md-12" style="margin-top: 20px;">
            <div class="row">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                ...
                <small>To Import CV's Download CSV Format <a href="<?php echo base_url(); ?>cv_bank_excel/files/Cv.csv"  target="_blank" download><strong>Click here To Download</strong></a></small>
              </div>
            </div>
          </div>
          <div class="col-md-12">
