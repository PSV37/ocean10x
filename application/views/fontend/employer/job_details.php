                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <a href="<?php echo site_url('employer/cancel_interview/'.$introw['id']); ?>" onclick="return confirm('Are you sure?');"  class="btn btn-danger btn-xs" title="Cancel Interview" data-toggle="tooltip" data-placement="top">Cancel</a>  
                                  <?php } else{ ?>
