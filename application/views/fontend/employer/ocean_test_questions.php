      ...
      <div class="col-md-12">
        ...
        <div class="col-md-9 test_d">
            ...
            <div class="multipleChoiceQues">
              ...
              <div class="quizBox">
                <form id="nextques" class="submit-form" action="<?php echo base_url();?>employer/insert_test_data" method="post">
                  ...
                  <? } else{ ?>
                  <button type="button" disabled="true" id="previous">DO NOT PRESS BACK KEY</button>
                  <?php } ?>     
          ...
          <div class="row preview" style=" margin-top: 150px;">
            ...
            <?php $i=1; foreach ($all_questions as $row) { ?>
            <div class="col-md-2 exp-box" style="display: none;" id="status<?php echo $i; ?>" onclick="getval(<?php echo $i; ?>);"><span name="levels[]" id="levels"   value=""><?php echo $i; ?></span></div>
      <?php }} ?>
          </div>
        </div>
<script>
              ...
              myQuestions.forEach(
                (currentQuestion, questionNumber) => {
                  ...
                  for(letter in currentQuestion.answers){
                    ...
                    answers.push(
                      `<label>
                        <input type="radio" onclick="get_checked(${questionNumber},'${letter}');" style="display:block;" id="${letter}${questionNumber}" name="question${questionNumber}" value="${letter}">
                        ${letter} :${ans}
                      </label>
                      `
                    );
