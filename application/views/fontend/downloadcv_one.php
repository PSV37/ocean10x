                  ...
                  Address: <?php echo $v_experience->address ;?>
                    ...
                    <br>  
                     Job Level: <?php echo $this->job_level_model->get_job_level_by_id($v_experience->job_level) ;?>
                       <br>  
                     Duration: <?php $today=date("Y-m-d"); if($v_experience->end_date=="1970-01-01" || $v_experience->end_date==null) {
                      echo date('j F,Y',strtotime($today)).' - Continuing';
                    }else { echo date_calculate($v_experience->end_date, $v_experience->start_date); }?>
                    <br>
...
<?php if(!empty($training_list)): ?>
    <table style="margin-top:3px;" align="center" border="0" cellpadding="0" cellspacing="0" width="630">
       ...
       <table style="border:1px solid #EAE7E7" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
           ...
           <td style="border-right:1px solid #EAE7E7" align="center" width="15%"><strong>Topic</strong></td>
           <td style="border-right:1px solid #EAE7E7" align="center" width="20%"><strong>Institute</strong></td>
           <td style="border-right:1px solid #EAE7E7" align="center" width="15%"><strong>Country</strong></td>
           <td style="border-right:1px solid #EAE7E7" align="center" width="15%"><strong>Year</strong></td>
           
                <td  align="center" width="15%"><strong>Duration</strong></td>              
