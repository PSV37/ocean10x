  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <h1 class="page-heading">Bank Info</h1>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="breadCrumb"><a href="#.">Home</a> / <span>Bank Info</span></div>
      </div>
    </div>
  </div>
</div>
<!-- Page Title End --> 
        ...
        <?php endif; ?>
                ...
                <?php echo (!empty($company_info->company_aboutus)?'<h3>Special Features</h3><p>'.$company_info->company_aboutus.'</p>':''); ?>
                
                 <?php echo (!empty($company_info->company_service)?'<h3>Attractive Offers</h3><p>'.$company_info->company_service.'</p>':''); ?>
...
<?php $companyJobs=$this->job_posting_model->get_company_active_banksbook($company_info->company_profile_id);
                                               ...
                                               foreach ($companyJobs as $v_jobs) :
                                                   ?>
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                            <h4 class="jbtitle"><a href="<?php echo base_url(); ?>job/show/<?php echo $v_jobs->job_slugs;?>"><?php echo $v_jobs->job_title;  ?></a></h4>
                                                            </td>
