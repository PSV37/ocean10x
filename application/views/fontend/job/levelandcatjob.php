...
<form id="allJobsearch" action="<?php echo base_url() ?>job" method="post">
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="searchform">
            <div class="row">
              <div class="col-md-5 col-sm-4">
                <input name="keyword" type="text" class="keyword-form form-control" placeholder="Keyword">
              </div>
              <div class="col-md-6 col-sm-6 select-location-padding">
                <select name="location_name[]"  class="selectpicker" data-style="form-control" data-live-search="true">
          ...
          <ul class="searchList">                    
                    <?php  if (!empty($alljobs)): foreach ($alljobs['result'] as $v_job) : ?>
                    <!-- job start -->
				    <li>
                        <div class="row">
                        ...
                        <div class="greybox">
          	<div class="infobox"><i class="fa fa-map-marker" aria-hidden="true"></i> <span><?php $joblocation=$this->job_location_model->get($v_job->job_location); echo $joblocation->job_location_name;  ?></span></div>
            <div class="infobox"><i class="fa fa-file-text" aria-hidden="true"></i> <?php echo $v_job->experience;?> year(s)</div>
            <div class="infobox"><i class="fa fa-calendar" aria-hidden="true"></i> Posted : <?php // echo $v_job->created_at; ?>
