...
<div class="col-md-1">
    ...
    <p tabindex="-98" class="profile-accoutnt-p data-toggle="tooltip title="<?php echo $this->Company_profile_model->company_name($employer_id); ?>"><?php echo $this->Company_profile_model->company_name($employer_id); ?></p>
    ...
    <ul class="dropdown-menu">
      ...
      <li><a href="<?php echo base_url() ?>employer/addemployee"><i class="fas fa-user"></i>Team Members</a> </li>
