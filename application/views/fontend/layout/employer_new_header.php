<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>fontend/css/responsive.css">
     ...
     <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>fontend/css/post_new_job.css">

     <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>fontend/css/dashboard.css">
