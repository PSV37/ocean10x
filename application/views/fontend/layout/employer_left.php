...
<div class="col-md-3">
  <nav class="side-menu hidden-sm hidden-xs">
    <ul>
      ...
      <li onclick="record_audit('Edit Profile');" value="Edit_Profile" id="Edit_Profile"> <a href="<?php echo base_url(); ?>employer/profile_setting"  class=""> <i class="fa fa-user-circle-o" aria-hidden="true" title="superadmin" data-toggle="modal" data-target="#superadmin"></i> Edit Profile </a> </li>
