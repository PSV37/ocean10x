...
<div class="col-md-3">
  <nav class="side-menu hidden-sm hidden-xs">
    <ul>
      ...
      <li   onclick="record_audit('Edit Profile','profile_setting');"  data-level_id='Edit_Profile' id="Edit_Profile" value=""> <a href="#" class=""> <i class="fa fa-user-circle-o" aria-hidden="true" ></i> Edit Profile </a> </li>
