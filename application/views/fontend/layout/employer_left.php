...
<div class="col-md-3">
  <nav class="side-menu hidden-sm hidden-xs">
    <ul>
      ...
      <li title="superadmin" data-toggle="modal" data-target="#superadmin"  onclick="record_audit('Edit Profile');"  data-level_id='Edit_Profile' id="Edit_Profile" value="<?php echo base_url(); ?>employer/profile_setting"> <a href="<?php echo base_url(); ?>employer/profile_setting"  class=""> <i class="fa fa-user-circle-o" aria-hidden="true" ></i> Edit Profile </a> </li>
