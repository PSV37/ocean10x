...
<div class="col-md-3">
  <nav class="side-menu hidden-sm hidden-xs">
    <ul>
      ...
      <li onclick="record_audit(this.value)" value="Edit Profile"> <a href="<?php echo base_url(); ?>employer/profile_setting"  class=""> <i class="fa fa-user-circle-o" aria-hidden="true"></i> Edit Profile </a> </li>
