                    ...
                    <input type="checkbox" />
                        ...
                        <div class="card">
                            <div class="front">
                                ...
                                <img src="https://upload.wikimedia.org/wikipedia/commons/8/83/Rivian_company_logo.jpg" style="height:25px; width:25px;border-radius:5px;float:left" />
                                
                                <div class="job-info">
                                	
                                    <div class="a"> 
                                <li class="right-title" style="font-size:19px;margin-top:-4px;" >Awaneesh Mishra</li>
                                    </div>
                                ...
                                <div class="following-info">
                                	<li class="left-title"
                                    >Email</li><li class="right-title">&nbsp;:shsshhh@gmail.com</li>
                                   
                                     <li class="left-title">Current Sal</li><li class="right-title">&nbsp;:40000</li>
                                    

                                     <li class="left-title">SkillSet</li><li class="right-title">&nbsp;: Java</li>
                                     <li class="left-title">Work Experince</li><li class="right-title">&nbsp;: 5</li>
                                   ...
                                   <li class="left-title">Current Org</li><li class="right-title">&nbsp;:TKNS</li>
                                	<li class="left-title">Notice Period </li><li class="right-title">&nbsp;:30 Days</li>
                                     <li class="left-title">Phone</li><li class="right-title">&nbsp;:6757256255</li>
                                     <li class="left-title">PHP</li><li class="right-title">&nbsp;:</li>
