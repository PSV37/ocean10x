	...
	<div class="container">
        <div class="col-md-12">
            ...
            <div class="col-md-6 active-job">
            	...
            	<img src="https://media-exp1.licdn.com/dms/image/C4E0BAQHbWPfQdNw1EA/company-logo_200_200/0?e=2159024400&v=beta&t=fWMuJX9leYFsDf-weERHLyIPfRh4aCOwx8wygmhad9Q" class="posted-job_img" />
               <div class="row">
                <p class="job-title">Php Developer</p>
               <ul class="extra">
               <li class="location"><i class="fas fa-map-marker-alt"></i>&emsp;Mumbai</li>
               <li class="experience"><i class="fas fa-archive"></i>&emsp;2-3 yaers</li>
					               
               </ul>
              </div>
              <div class="row" style="margin-left: 71px; margin-top: -18px;">
              	<p class="sec-row">Engagement type:</p>
