...
<div class="col-md-1">
    ...
    <div class="col-md-2">
    	 <div class="dropdown">
  <i class="fas fa-user-circle"><img src="<?php echo base_url() ?>upload/<?php echo  $this->Job_seeker_photo_model->get_jobseeker_photo($job_seeker);?>" alt="" ></i>&emsp;<a class=" dropdown-toggle" data-toggle="dropdown">
