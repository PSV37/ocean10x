...
.modal-header{border-bottom:none;padding:15px 15px 0px 15px}
                    ...
                    <li class="dropdown yamm-half membermenu hasmenu">
                       ...
                       <?php else: ?>
                        ...
                        <ul class="dropdown-menu start-right">
                            ...
                            <li><a href="#" style="color: black;" class="btn-logoff" data-toggle="modal" data-target="#modal_logoff"><span class="glyphicon glyphicon-lock"></span> Logout</a></li>
                        </ul>
                    </li>
