<div class="chatbody">
                ...
                <div class="panel-footer">
                    <div class="input-group">
                        ...
                        <button class="btn btn-primary btn-sm" value="" id="btn-chat" onclick="send_msg(<?php echo $check['emp_js_connection_id']; ?>); get_list();"><i class="fa fa-send fa-1x" aria-hidden="true"></i></button>
                        </span>
                    </div>
                </div>
            </div>
