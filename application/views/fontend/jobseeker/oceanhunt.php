         ...
         <div class="front">
            ...
            <div class="following-info3">
             ...
             <?php  }elseif ($singlejob->is_test_required == 'Yes' && !empty($singlejob->test_for_job) && !empty($apply)) { 
              ...
              ?>
              <a style="margin-left: 15px" title="Give test" href="<?php echo base_url() ?>job_seeker/ocean_test_start/<?php echo base64_encode($job_post_id) ?>/<?php echo base64_encode($apply_id); ?>/<?php echo $singlejob->job_post_id ?>" ><i class="fa fa-file-text" aria-hidden="true"></i></a>
            <?php } ?></li>
