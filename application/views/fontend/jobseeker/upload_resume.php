                ...
                <div class="containe1r">
                  ...
                  <form class="avatar-form" action="<?php echo base_url('Job_seeker/save_attached_resume');?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="col-md-6">
                      ...
                      <p>Last Updated: <?php if(!empty($job_seeker_resume['updated_on'])){echo date('d-M-Y', strtotime($job_seeker_resume['updated_on']));}else{echo date('d-M-Y', strtotime($job_seeker_resume['created_on']));} ?></p><br>
                    </div>
                    <div class="col-md-6">
                      <!-- Upload image and data -->
                      <div class="col-md-12">
