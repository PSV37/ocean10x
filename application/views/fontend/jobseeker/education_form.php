...
<?php if(!empty($education_level)) if($education_level['education_level_name']=='Ph.D / Doctorate' || $education_level['education_level_name']=='Masters/Post-Graduation' || $education_level['education_level_name']=='Gradution/Diploma'){?>
      ...
      <div class="form-group" id="comp_name" <?php if(!empty($edit_edu_res)){ if($edit_edu_res['gradding']=='Course Requires a Pass') {?> style="display:none;"<?php }else{ ?>style="display:block;"<?php } }else{ ?>style="display:none;">
        <div class="col-sm-1"></div>
        <div class="col-sm-10">
