            ...
            <label>
              ...
              <div class="card content">
                <div class="front">
                 ...
                 <button class="btn btn-link dropdown-toggle" type="button" id="gedf-drop1" data-toggle="dropdown"  aria-expanded="false">
...
<script>
  ...
  $("#test_name").autocomplete({
               ...
               source: "<?php echo base_url();?>job_seeker/search_test_keywords",
               minLength: 2,
                // append: "#rotateModal",
