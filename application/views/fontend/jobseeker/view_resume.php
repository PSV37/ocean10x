                            ...
                            <div class="contentbox">
                                ...
                                <header class="row cv-box">
                                    ...
                                    <div class="social col-md-3">
                                       <img src="<?php echo base_url() ?>upload/<?php if(!empty($resume->photo_path)) { echo $resume->photo_path;} else { echo "image-notfound.png";} ?>" style="width: 160px"  class="seeker-profile-title" title="That`s me!" alt="My Profile"/>
                                    </div>
  ...
  <?php endif; ?>
            ...
            <article class="row cv-box">
				...
				<input type="text" name="cid" id="cid" value="<?php echo $traningresult['job_seeker_id'];?>">
                  <?php echo "<pre>"; print_r($traningresult); if (!empty($training_list)): foreach ($training_list as $v_training) : ?>
