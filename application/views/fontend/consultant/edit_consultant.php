  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <h1 class="page-heading">Edit consultant</h1>
      </div>
      <div class="col-md-6 col-sm-6">
        <div class="breadCrumb"><a href="#.">Home</a> / <span>Edit consultant</span></div>
      </div>
    </div>
  </div>
</div>
...
<!-- <?php print_r($company_info) ?>  -->
        ...
        <form method="post" action="<?php echo base_url();?>employer/addconsultant" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="consultant_id" id="consultant_id"value="<?php echo $consultant_id;?>">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">   
                                           <div class="formrow">
                                            <label class="control-label">Consultancy Name: <span class="required">*</span></label>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                          <div class="formrow">
                                            <label class="control-label">Consultancy Email: <span class="required">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                          <div class="formrow">
                                          <label class="control-label">Consultancy URL:</label>
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                          <div class="formrow">
                      <label class="control-label">Consultancy Code:</label>
                      ...
                      <div class="col-md-3 col-sm-12">
                                          <div class="formrow">
                                          <label class="control-label">Consultancy Phone: <span class="required">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                          <div class="formrow">
                                          <label class="control-label">Consultancy Contact Person: <span class="required">*</span></label>  
                                         ...
                                         <div class="col-md-6 col-sm-12">
                                 <div class="formrow">
                                       <label class="control-label">Consultancy Person Email: <span class="required">*</span></label>
                   ...
                   <div class="row">
                                 ...
                                 <div class="col-md-6 col-sm-12">
                                  <div class="formrow">
                                    <label class="control-label">Consultancy Person Mobile: <span class="required">*</span></label>
                                 ...
                                 <div class="col-md-6 col-sm-6">
                            <div class="formrow">
                              <label class="control-label">Consultancy Career Link:</label>
